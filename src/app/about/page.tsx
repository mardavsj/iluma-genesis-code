            ...
            <div className="p-8 max-w-4xl mx-auto">
                ...
                <div className="mt-12">
                    ...
                    <p className="text-gray-400 mb-4">
                        If you find Star Code Editor helpful and want to support its development, consider buying us a coffee:
                    </p>
